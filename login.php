...
if (isset($_POST['submit'])) {
    ...
    if ($row) {
        ...
        if ($row['role'] === 'admin') {
            header('Location: dashboard/index.php'); // Redirect ke halaman admin
        } else {
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="https://satriadata.kemdikbud.go.id/wp-content/uploads/2020/08/Logo-kemendikbud.png" alt="logo" width="170">
            </div>
